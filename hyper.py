...
#}
common_hyperparameters = {
    'lr': hp.uniform('lr', low=1e-4, high=1e-3),
    'weight_decay': hp.uniform('weight_decay', low=0, high=3e-3),
    'patience': hp.choice('patience', [30]),
...
mpnn_hyperparameters = {
    'node_out_feats': hp.choice('node_out_feats', [128]),
    'edge_hidden_feats': hp.choice('edge_hidden_feats', [128]),
    'num_step_message_passing': hp.choice('num_step_message_passing', [5,6,7]),
    'num_step_set2set': hp.choice('num_step_set2set', [5,6,7]),
